...
class MainWatchface : CanvasWatchFaceService() {
    ...
    private class EngineHandler(reference: MainWatchface.Engine) : Handler(Looper.myLooper()!!) {
        private val mWeakReference: WeakReference<MainWatchface.Engine> = WeakReference(reference)
    ...
    inner class Engine : CanvasWatchFaceService.Engine() {
        ...
        override fun onCreate(holder: SurfaceHolder) {
            ...
            setWatchFaceStyle(
                WatchFaceStyle.Builder(this@MainWatchface)
                    .build()
            )

            mCalendar = Calendar.getInstance()

            val resources = this@MainWatchface.resources
        ...
        private fun registerReceiver() {
            ...
            this@MainWatchface.registerReceiver(mTimeZoneReceiver, filter)
        }
        ...
        private fun unregisterReceiver() {
            ...
            this@MainWatchface.unregisterReceiver(mTimeZoneReceiver)
        }
